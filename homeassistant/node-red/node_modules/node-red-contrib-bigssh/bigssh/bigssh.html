...
<script type="text/x-red" data-template-name="SSH_Credentials">
    ...
    <div class="form-row">
        <label for="node-config-input-algorithms"><i class="fa fa-user"></i> <span data-i18n="bigssh.label.algorithms"></span></label>
        <input type="text" id="node-config-input-algorithms">
    </div>	
    <div class="form-row">
        <label for="node-config-input-password" style="width: 30%;" ><i class="fa fa-lock"></i> <span data-i18n="bigssh.label.password"></span></label>
        <input type="password" style="width: 60%;" id="node-config-input-password">
    </div>    	
</script>
